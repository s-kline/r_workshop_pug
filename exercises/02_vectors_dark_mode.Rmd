...
```{r}
char_vector <-  c("hello", "world", "are", "you", "listening", "?")
char_vector

num_vector <- c(1, 2, 3, 4, 5, 6.1)
num_vector

bool_vector <- c(TRUE, TRUE, FALSE, TRUE, FALSE)
bool_vector
```
...
c(char_vector, num_vector)
c(num_vector, bool_vector)
...
```
 where other languages use loops, r users use vectors because they are so powerful
